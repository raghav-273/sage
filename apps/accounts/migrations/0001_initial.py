    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_system_role", models.BooleanField(default=True, help_text="System roles cannot be deleted; only custom roles can.")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("permission_overrides", models.JSONField(blank=True, default=dict, help_text='{"grant": ["permission_name"], "revoke": ["permission_name"]}')),
                ...
                ("requires_password_reset", models.BooleanField(default=False, help_text="Set True by administrators to force a password change on next login.",)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("target_type", models.CharField(blank=True, default="", max_length=50, help_text="e.g. 'document', 'user', 'session'")),
                ("target_id", models.CharField(blank=True, default="", max_length=100)),
                ("target_label", models.CharField(blank=True, default="", max_length=500, help_text="Human-readable name of the target, denormalised.")),
