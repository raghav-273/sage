...
LOGIN_CHALLENGE_FAILURE_THRESHOLD = env.int("LOGIN_CHALLENGE_FAILURE_THRESHOLD", default=1)
...
# Login lockout — harder than the Turnstile challenge; temporarily blocks
# ALL login attempts from an IP, regardless of credentials or Turnstile status.
